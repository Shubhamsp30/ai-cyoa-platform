...
const UI_LABELS: Record<Language, Record<string, string>> = {
    'en': {
        ...
        'tactical_error': '❌ Wrong Move! Try something else! 🛡️⚔️🚩|⚠️ That action is not advised. Adjust your strategy!|🚫 Strategic Error. Rethink your next move, warrior.',
        'mission_updated': '✅ Great Job! Moving forward! ⚔️🏰🔥|🎖️ Mission Objective Met. Proceeding to next phase.|🔥 Success! Your command has changed the tide of battle!',
        'command_failed': '⚠️ System Error! Please try again. 🤖',
        'tactical_hint_btn': '[ GET INTEL ]',
        'tactical_hint_label': 'TACTICAL HINT:',
    },
    'hi': {
        ...
        'tactical_error': '❌ गलत जवाब! फिर से कोशिश करें! 🛡️⚔️🚩|⚠️ यह कदम सही नहीं है। अपनी रणनीति बदलें!|🚫 सामरिक गलती। योद्धा, अपने अगले कदम पर फिर से विचार करें।',
        'mission_updated': '✅ बहुत बढ़िया! आगे बढ़ें! ⚔️🏰🔥|🎖️ मिशन का उद्देश्य पूरा हुआ। अगले चरण पर बढ़ रहे हैं।|🔥 सफलता! आपके आदेश ने युद्ध की दिशा बदल दी है!',
        'command_failed': '⚠️ सिस्टम त्रुटि! फिर से प्रयास करें। 🤖',
        'tactical_hint_btn': '[ हिंट लें ]',
        'tactical_hint_label': 'सामरिक संकेत:',
    },
    'mr': {
        'start': 'साहस सुरू करा',
        ...
        'tactical_error': '❌ चुकीचा पर्याय! पुन्हा प्रयत्न करा! 🛡️⚔️🚩|⚠️ ही कृती योग्य नाही. तुमची रणनीती बदला!|🚫 धोरणात्मक चूक. मावळ्या, तुमच्या पुढच्या निर्णयाचा पुनर्विचार करा.',
        'mission_updated': '✅ उत्तम! पुढे चला! ⚔️🏰🔥|🎖️ मोहिमेचे उद्दिष्ट पूर्ण झाले. पुढच्या टप्प्यावर जात आहोत.|🔥 यश! तुमच्या आज्ञेने युद्धाचे वळण बदलले आहे!',
        'command_failed': '⚠️ सिस्टम त्रुटी! पुन्हा प्रयत्न करा. 🤖',
        'tactical_hint_btn': '[ हिंट मिळवा ]',
        'tactical_hint_label': 'सामरिक सूचना:',
    },
    'hi-en': { // Hinglish
        ...
        'tactical_error': '❌ Galat jawab! Phir se try karein! 🛡️⚔️🚩|⚠️ Yeh move sahi nahi hai. Strategy badlein!|🚫 Strategic mistake. Warrior, apne agle kadam ke baare mein phir se sochein.',
        'mission_updated': '✅ Bahut badhiya! Aage badhein! ⚔️🏰🔥|🎖️ Mission objective poora hua. Next phase par badh rahe hain.|🔥 Success! Aapke order ne battle ka rukh badal diya hai!',
        'command_failed': '⚠️ System Error! Phir se try karein. 🤖',
        'tactical_hint_btn': '[ HINT LEIN ]',
        'tactical_hint_label': 'TACTICAL HINT:',
    },
    'mr-en': { // Marathlish
        ...
        'tactical_error': '❌ Chukicha paryay! Punha prayatna kara! 🛡️⚔️🚩|⚠️ He move barobar nahiye. Strategy badla!|🚫 Strategic mistake. Mavlya, tumcha pudhcha decision punha check kara.',
        'mission_updated': '✅ Uttam! Pudhe chala! ⚔️🏰🔥|🎖️ Mission objective purna jhala. Pudhcha phase chalu hot ahe.|🔥 Yash! Tumchya decision mule yuddhacha rukh badalla ahe!',
        'command_failed': '⚠️ System Error! Punha prayatna kara. 🤖',
        'tactical_hint_btn': '[ HINT MILVA ]',
        'tactical_hint_label': 'TACTICAL HINT:',
    },
}
